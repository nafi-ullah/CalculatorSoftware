 ...
 * @author NAFI
 */
public class CalculateAll implements ActionListener{

    double num1=0,num2=0, result=0,answer,number;
    int calculation;
    ...
    public static void main(String[] args) {
        ...
        CalculateAll calculator= new CalculateAll();
    }
